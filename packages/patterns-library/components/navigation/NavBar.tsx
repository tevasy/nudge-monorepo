  ...
  return (
    <>
      ...
      >
        ...
        {/* Logo */}
        <Link href="/overview">
          <span className="uppercase font-bold text-customBlack text-lg sm:text-2xl mb-1 font-grotesk">
            Nudge
            <span className="inline-block w-1.5 h-1.5 md:w-2.5 md:h-2.5 rounded-full ml-2 mr-2 md:ml-3.5 md:mr-3.5 mb-1 bg-customOrange will-change-transform animate-[pulseColor_2s_infinite_ease-in-out]"></span>
            Patterns
            <span className="inline-block w-1.5 h-1.5 md:w-2.5 md:h-2.5 rounded-full ml-2 mr-2 md:ml-3.5 md:mr-3.5 mb-1 bg-customOrange will-change-transform animate-[pulseColor_2s_infinite_ease-in-out]"></span>
            Library
          </span>
