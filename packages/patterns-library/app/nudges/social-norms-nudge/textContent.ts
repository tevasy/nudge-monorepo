export const textContent = {
  ...
  installCommands: [
    "npm install nudge-components-library/social-norms",
  ...
  overview: {
    ...
    exampleText:
      "Screenshot of Coursera's “Google Prompting Essentials” course page, illustrating the Social Norms Nudge.",
    image: {
  ...
  problem: {
    title: "Problem",
    content:
      "Users often **face uncertainty when making decisions, especially in unfamiliar environments where they lack prior experience or knowledge**. This uncertainty can lead to hesitation, poor choices, or even avoiding a decision altogether. The Social Norms Nudge tackles this by showing what others have done, which provides a sense of reassurance. When users see that many people have made a particular choice, they feel more confident following the same path.",
  },
  context: {
    title: "Context",
    content:
