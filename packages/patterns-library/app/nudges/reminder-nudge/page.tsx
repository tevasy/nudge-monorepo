...
import PopupDocs from "../../../components/nudgePages/implementation/reminderNudge/PopupDocs";
    ...
    <div className="flex-1">
      ...
      >
        ...
        <p className="mb-4">
          ...
          or &nbsp;
          <span className="font-mono text-[15px] bg-customLightLightBlue rounded-md py-1 px-1.5">
            npm install nudge-components-library/reminder
          </span>
        ...
        <section id="popup" className="scroll-mt-64">
          <h3 className="text-xl font-bold mt-10 mb-4">
            {textContent.popup.title}
          </h3>
          <div className="mb-4">
            <ReactMarkdown>{textContent.popup.content}</ReactMarkdown>
          </div>
          <PopupDocs />
        </section>
