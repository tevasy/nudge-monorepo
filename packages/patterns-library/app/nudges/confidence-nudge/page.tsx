...
import TooltipDocs from "../../../components/nudgePages/implementation/confidenceNudge/TooltipDocs";
  ...
  return (
    <div className="flex-1">
      ...
      >
        ...
        <p className="mb-4">
          Confidence nudges can be implemented using the <b>Tooltip</b>{" "}
          ...
          or &nbsp;
          <span className="font-mono text-[15px] bg-customLightLightBlue rounded-md py-1 px-1.5">
            npm install nudge-components-library/confidence
          </span>
        ...
        <section id="tooltip" className="scroll-mt-64">
          <h3 className="text-xl font-bold mt-10 mb-4">
            {textContent.tooltip.title}
          </h3>
          <div className="mb-4">
            <ReactMarkdown>{textContent.tooltip.content}</ReactMarkdown>
          </div>
          <TooltipDocs />
        </section>
        <section id="api-reference" className="scroll-mt-64">
          ...
          <ComponentDocumentationTabs tabsData={documentationData.confidence} />
        </section>
      </section>
    </div>
  );
