    ...
    <html lang="en">
      <body className="min-h-screen text-customBlack no-underline">
        {showSpinner && (
          ...
          >
            <span className="text-center pr-5 pl-5 uppercase animate-pulse font-bold text-customLightLightBlue text-4xl sm:text-5xl md:text-6xl font-grotesk mb-14 sm:mb-20">
              Nudge Patterns Library
            </span>
          </div>
        )}
